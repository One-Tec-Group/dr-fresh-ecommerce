...
@section('content')
    ...
    <section class="pt-3 pb-3 page-info section-padding border-bottom bg-white">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{url('/')}}"><strong><span class="mdi mdi-home"></span> @lang('ecommerce::locale.home')
                        </strong>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="shop-detail-right">
                        ...
                        @else
                            <p class="float-right"><span class="badge "
                                                         style="border: 1px solid #dc3545 !important; color: #dc3545 !important;">غير متاح</span>
                            </p>
                        @endif
                        ...
                        <div class="d-flex">
                            <div class="d-flex">
                                <span class="input-group-btn"><button
                                            class="btn btn-theme-round btn-number p-2 my-0 mx-1"
            ...
            <div class="section-header">
                <h5 class="heading-design-h5">@lang('ecommerce::locale.products_like')<span
                    ...
                    <a class="float-right text-secondary"
                       href="{{url('ecommerce/products?category='. $product->category && $product->category->id ? $product->category->id : '')}}">@lang('ecommerce::locale.view_all')</a>
                </h5>
            </div>
