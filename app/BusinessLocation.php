...
class BusinessLocation extends Model
{
    ...
    public static function forDropdownLocationsOnly($business_id, $show_all = false, $receipt_printer_type_attribute = false, $append_id = true, $check_permission = true)
    {
        $query = BusinessLocation::where('business_id', $business_id)->where('type','location')->Active();
    ...
    public static function specificLocationStore($business_id,$store, $show_all = false, $receipt_printer_type_attribute = false, $append_id = true, $check_permission = true)
    {
        $query = BusinessLocation::where('business_id', $business_id)->where('type','store')->where('id',$store)->Active();
