...
class Transaction extends Model
{
    ...
    {
        return $this->belongsToMany(Address::class,'delivery_boy_transactions','transaction_id','address_delivery_id')->withPivot('delivery_price');
    }

    public function delivery_boys()
    {
        return $this->belongsToMany(DeliveryBoy::class,'delivery_boy_transactions','transaction_id','delivery_boy_id');
    }
